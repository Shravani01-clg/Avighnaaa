// dotenv is loaded by the parent server; simulator uses defaults unless env vars are set
const config = {
  // Backend API
  apiUrl: process.env.API_URL || "http://localhost:5000",
  deviceApiKey: process.env.DEVICE_API_KEY || "test-device-key-123",

  // Device identity (simulates an ESP32)
  deviceId: process.env.SIM_DEVICE_ID || "SIM-DEVICE-001",
